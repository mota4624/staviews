class Review < ApplicationRecord
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[brand category_id created_at id negative_point positive_point product_name purchase_date
       recommendation title updated_at user_id user_type]
  end

  def self.ransackable_associations(_auth_object = nil)
    %w[category comments images_attachments images_blobs user]
  end
